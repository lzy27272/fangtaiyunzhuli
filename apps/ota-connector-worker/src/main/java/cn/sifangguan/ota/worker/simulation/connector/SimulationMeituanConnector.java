...
public final class SimulationMeituanConnector extends AbstractSimulationConnector {
    public static final String CONNECTOR_CODE = "MOCK_MEITUAN";

    public SimulationMeituanConnector(Clock clock) {
