...
export function ExceptionCenterPage({
  ...
  return (
    <section className="console-page exception-page">
      <div className="page-title-row"><div><p className="section-kicker">异常处理中心</p><h1>异常处理</h1><p>只提供可回退的安全动作；厂家验证码和风控确认仍由管理员在官网完成。</p></div><button className="quiet-button" type="button" onClick={() => void refresh()}><Icon name="refresh" />重新检查</button></div>
