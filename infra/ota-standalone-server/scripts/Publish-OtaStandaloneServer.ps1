...
$runtimeSourcePaths = @(
    ...
    'tools/uat/ota-cloud-browser-policy.mjs',
    'tools/uat/ota-cloud-browser-client.mjs',
    'tools/uat/ota-cloud-browser.mjs',
    'tools/uat/ota-cloud-browser-worker.mjs',
    'tools/labs/ota-browser/ctrip-data-contract.mjs',
    'tools/labs/ota-browser/ctrip-data-engine.mjs',
    'tools/labs/ota-browser/ctrip-monthly-data.mjs',
    'tools/labs/ota-browser/meituan-data-contract.mjs',
    'tools/labs/ota-browser/meituan-data-engine.mjs',
    'tools/labs/ota-browser/meituan-login-network.mjs',
    'infra/ota-standalone-server/systemd/sifangguan-ota-cloud.service',
    'infra/ota-standalone-server/systemd/ota-cloud-api-access.conf',
    'infra/ota-standalone-server/scripts/configure-ota-cloud-browser.sh',
